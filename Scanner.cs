...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 97; i <= 98; ++i) start[i] = 1;
		for (int i = 101; i <= 117; ++i) start[i] = 1;
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 1:
				{t.kind = 1; break;}
			case 2:
				if (ch == 'n') {AddCh(); goto case 3;}
				else {goto case 0;}
			case 3:
				if (ch == 's') {AddCh(); goto case 4;}
				else {goto case 0;}
			case 4:
